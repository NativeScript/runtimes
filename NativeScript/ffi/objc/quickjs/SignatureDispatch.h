#ifndef NATIVESCRIPT_FFI_QUICKJS_SIGNATURE_DISPATCH_H
#define NATIVESCRIPT_FFI_QUICKJS_SIGNATURE_DISPATCH_H
...
#endif  // NATIVESCRIPT_FFI_QUICKJS_SIGNATURE_DISPATCH_H

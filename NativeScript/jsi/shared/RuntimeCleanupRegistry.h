#ifndef NATIVESCRIPT_JSI_SHARED_RUNTIME_CLEANUP_REGISTRY_H
#define NATIVESCRIPT_JSI_SHARED_RUNTIME_CLEANUP_REGISTRY_H
...
#endif  // NATIVESCRIPT_JSI_SHARED_RUNTIME_CLEANUP_REGISTRY_H

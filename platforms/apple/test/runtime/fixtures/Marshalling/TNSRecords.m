...
TNSVerySimpleStruct getSimpleStruct() {
  TNSVerySimpleStruct simpleStruct = {.x1 = 100,
                                      .y1 = {{.x2 = 10, .x3 = 20}, {.x2 = 30, .x3 = 40}}};

  return simpleStruct;
}

NestedSimpleStruct getNestedStruct() {
  NestedSimpleStruct simpleStruct = {.y1 = {.x2 = 12.34, .x3 = 3.675},
                                     .y2 = {.x2 = 31.34, .x3 = 67.675}};
  return simpleStruct;
}
...
TNSComplexStruct getComplexStruct() {
  TNSComplexStruct result = {
      .x1 = 100,
      .y1 = {{.x2 = 10, .y2 = {.x3 = {1, 2}}}, {.x2 = 20, .y2 = {.x3 = {3, 4}}}},
      .x4 = 123456};
...
TNSStructWithFloat2 getStructWithFloat2() {
  TNSStructWithFloat2 result = {.f = getFloat2(), .i = 5};

  return result;
}

TNSStructWith2Floats getStructWith2Floats() {
  TNSStructWith2Floats result = {.f1 = 1.2345, .f2 = 2.3456};

  return result;
}

TNSStructWith3Floats getStructWith3Floats() {
  TNSStructWith3Floats result = {.f1 = 1.2345, .f2 = 2.3456, .f3 = 3.4567};

  return result;
}

TNSStructWith4Floats getStructWith4Floats() {
  TNSStructWith4Floats result = {.f1 = 1.2345, .f2 = 2.3456, .f3 = 3.4567, .f4 = 4.5678};

  return result;
}

TNSStructWith2Doubles getStructWith2Doubles() {
  TNSStructWith2Doubles result = {.d1 = 1.2345, .d2 = 2.3456};

  return result;
}

TNSStructWith3Doubles getStructWith3Doubles() {
  TNSStructWith3Doubles result = {.d1 = 1.2345, .d2 = 2.3456, .d3 = 3.4567};

  return result;
}

TNSStructWith4Doubles getStructWith4Doubles() {
  TNSStructWith4Doubles result = {.d1 = 1.2345, .d2 = 2.3456, .d3 = 3.4567, .d4 = 4.5678};
...
simd_float3 _SCNVector3ToFloat3(SCNVector3 v) { return SCNVector3ToFloat3(v); }

simd_float4 _SCNVector4ToFloat4(SCNVector4 v) { return SCNVector4ToFloat4(v); }

simd_float4x4 _SCNMatrix4ToMat4(SCNMatrix4 m) { return SCNMatrix4ToMat4(m); }

SCNVector3 _SCNVector3FromFloat3(simd_float3 v) { return SCNVector3FromFloat3(v); }

SCNVector4 _SCNVector4FromFloat4(simd_float4 v) { return SCNVector4FromFloat4(v); }

SCNMatrix4 _SCNMatrix4FromMat4(simd_float4x4 m) { return SCNMatrix4FromMat4(m); }

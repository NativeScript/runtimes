...
+ (void)inheritanceConstructorCalls:(Class)JSDerivedInterface {
  NSAssert([[[JSDerivedInterface alloc] initBaseProtocolMethod1] isKindOfClass:JSDerivedInterface],
           @"initBaseProtocolMethod1 failed");
  NSAssert([[[JSDerivedInterface alloc] initBaseProtocolMethod1Optional]
               isKindOfClass:JSDerivedInterface],
           @"initBaseProtocolMethod1Optional failed");
  NSAssert([[[JSDerivedInterface alloc] initBaseProtocolMethod2] isKindOfClass:JSDerivedInterface],
           @"initBaseProtocolMethod2 failed");
  NSAssert([[[JSDerivedInterface alloc] initBaseProtocolMethod2Optional]
               isKindOfClass:JSDerivedInterface],
           @"initBaseProtocolMethod2Optional failed");
  NSAssert([[[JSDerivedInterface alloc] initBaseMethod] isKindOfClass:JSDerivedInterface],
           @"initBaseMethod failed");
  NSAssert([[[JSDerivedInterface alloc] initBaseCategoryProtocolMethod1]
               isKindOfClass:JSDerivedInterface],
           @"initBaseCategoryProtocolMethod1 failed");
  NSAssert([[[JSDerivedInterface alloc] initBaseCategoryProtocolMethod1Optional]
               isKindOfClass:JSDerivedInterface],
           @"initBaseCategoryProtocolMethod1Optional failed");
  NSAssert([[[JSDerivedInterface alloc] initBaseCategoryProtocolMethod2]
               isKindOfClass:JSDerivedInterface],
           @"initBaseCategoryProtocolMethod2 failed");
  NSAssert([[[JSDerivedInterface alloc] initBaseCategoryProtocolMethod2Optional]
               isKindOfClass:JSDerivedInterface],
           @"initBaseCategoryProtocolMethod2Optional failed");
  NSAssert([[[JSDerivedInterface alloc] initBaseCategoryMethod] isKindOfClass:JSDerivedInterface],
           @"initBaseCategoryMethod failed");
  NSAssert(
      [[[JSDerivedInterface alloc] initDerivedProtocolMethod1] isKindOfClass:JSDerivedInterface],
      @"initDerivedProtocolMethod1 failed");
  NSAssert([[[JSDerivedInterface alloc] initDerivedProtocolMethod1Optional]
               isKindOfClass:JSDerivedInterface],
           @"initDerivedProtocolMethod1Optional failed");
  NSAssert(
      [[[JSDerivedInterface alloc] initDerivedProtocolMethod2] isKindOfClass:JSDerivedInterface],
      @"initDerivedProtocolMethod2 failed");
  NSAssert([[[JSDerivedInterface alloc] initDerivedProtocolMethod2Optional]
               isKindOfClass:JSDerivedInterface],
           @"initDerivedProtocolMethod2Optional failed");
  NSAssert([[[JSDerivedInterface alloc] initDerivedMethod] isKindOfClass:JSDerivedInterface],
           @"initDerivedMethod failed");
  NSAssert([[[JSDerivedInterface alloc] initDerivedCategoryProtocolMethod1]
               isKindOfClass:JSDerivedInterface],
           @"initDerivedCategoryProtocolMethod1 failed");
  NSAssert([[[JSDerivedInterface alloc] initDerivedCategoryProtocolMethod1Optional]
               isKindOfClass:JSDerivedInterface],
           @"initDerivedCategoryProtocolMethod1Optional failed");
  NSAssert([[[JSDerivedInterface alloc] initDerivedCategoryProtocolMethod2]
               isKindOfClass:JSDerivedInterface],
           @"initDerivedCategoryProtocolMethod2 failed");
  NSAssert([[[JSDerivedInterface alloc] initDerivedCategoryProtocolMethod2Optional]
               isKindOfClass:JSDerivedInterface],
           @"initDerivedCategoryProtocolMethod2Optional failed");
  NSAssert(
      [[[JSDerivedInterface alloc] initDerivedCategoryMethod] isKindOfClass:JSDerivedInterface],
      @"initDerivedCategoryMethod failed");
}
...
+ (void)apiReadonlyPropertyInProtocolAndOverrideWithSetterInInterface:(TNSPlatformView*)object {
  NSAssert(CGRectEqualToRect([object bounds], CGRectMake(10, 20, 30, 40)),
...
+ (void)apiNSErrorExpose:(TNSApi*)object {
  {
    NSError* error = nil;
    NSAssert(((BOOL (*)(id, SEL, int, NSError**))objc_msgSend)(
                 object, NSSelectorFromString(@"method:error2:"), 0, &error) == true,
             NSStringFromSelector(_cmd));
    NSAssert(error == nil, NSStringFromSelector(_cmd));
  }

  NSAssert(((BOOL (*)(id, SEL, int, NSError**))objc_msgSend)(
               object, NSSelectorFromString(@"method:error2:"), 1, nil) == false,
           NSStringFromSelector(_cmd));

  {
    NSError* error = nil;
    NSAssert(((BOOL (*)(id, SEL, int, NSError**))objc_msgSend)(
                 object, NSSelectorFromString(@"method:error2:"), 1, &error) == false,
             NSStringFromSelector(_cmd));
    TNSLog(error.domain);
  }
}
...
+ (void)protocolImplementationMethods:(id<TNSBaseProtocol1, NSObject>)object {
  ...
  NSAssert([[object class] conformsToProtocol:@protocol(TNSBaseProtocol1)],
           NSStringFromSelector(_cmd));
  [object baseProtocolMethod1];
}

+ (void)categoryProtocolImplementationMethods:(id<TNSBaseCategoryProtocol1, NSObject>)object {
  NSAssert([object conformsToProtocol:@protocol(TNSBaseCategoryProtocol1)],
           NSStringFromSelector(_cmd));
  NSAssert([[object class] conformsToProtocol:@protocol(TNSBaseCategoryProtocol1)],
           NSStringFromSelector(_cmd));
  [object baseCategoryProtocolMethod1];
}
...
+ (void)protocolImplementationProtocolInheritance:(id<TNSBaseProtocol2, NSObject>)object {
  ...
  NSAssert([[object class] conformsToProtocol:@protocol(TNSBaseProtocol2)],
           NSStringFromSelector(_cmd));
  [object baseProtocolMethod2];
}
...
+ (TNSNestedStruct)recordsNestedStruct:(TNSNestedStruct)object {
  TNSLog(
      [NSString stringWithFormat:@"%d %d %d %d", object.a.x, object.a.y, object.b.x, object.b.y]);
  return object;
}

+ (TNSStructWithArray)recordsStructWithArray:(TNSStructWithArray)object {
  TNSLog([NSString stringWithFormat:@"%d %d %d %d %d", object.x, object.arr[0], object.arr[1],
                                    object.arr[2], object.arr[3]]);
  return object;
}
...
+ (TNSComplexStruct)recordsComplexStruct:(TNSComplexStruct)object {
  TNSLog([NSString stringWithFormat:@"%d %d %d %d %d %d %d", object.x1, object.y1[0].x2,
                                    object.y1[0].y2.x3[0], object.y1[0].y2.x3[1], object.y1[1].x2,
                                    object.y1[1].y2.x3[0], object.y1[1].y2.x3[1]]);
  return object;
}
